...
def run_experiment(experiments):
    ...
    if "1" in experiment_list:
        ...
        for eval_annot_dataset in zeroshot_eval:
            ...
            print('***** Finished first half of evaluation of {} at {} *****'.
                  format(EXP_NAME, datetime.datetime.now()))

            output_eval_file = os.path.join(temp_output_dir,
                                            'eval_results.txt')
    ...
    if "2" in experiment_list:
        ...
        translated_train = ['cb-annot-en-es']
    ...
    if "2" in experiment_list:
        ...
        #Some debug code - remove
        translated_train = ['cb-annot-en-fr']
    ...
    if "2" in experiment_list:
        ...
        #Some debug code - remove
        translated_train = ['cb-annot-en-pt']
