...
def model_init(num_train_steps, num_warmup_steps, num_labels=3):
    #Initiation
...
def main():
    ...
    for _ in range(iterations):
        ...
        for dataset in zeroshot_train:
            ...
            estimator_from_checkpoints = model_init(num_train_steps, num_warmup_steps, num_labels=len(label_list))    
